package novalinx.core.lib.base.core

import novalinx.core.lib.channel.AbstractChannelFlavors
...
object AppChannel : AbstractChannelFlavors {
    ...
    private const val IMPL_CLASS_NAME = "novalinx.core.lib.channel.ChannelFlavorsIMPL"
